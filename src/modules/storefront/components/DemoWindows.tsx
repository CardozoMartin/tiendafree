import { Check, Globe, Inbox, MousePointer2, Package, Palette, ShoppingBag, Star, Store } from "lucide-react";
...
export const DemoWindow = () => {
  ...
  useEffect(() => {
    ...
    let unmounted = false;
    const titles = ['TiendiZi', 'MiTienda', 'UrbanLook'];
    let loops = 0;
