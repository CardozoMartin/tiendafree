...
const HeroGallery = () => (
  <section className="px-6 md:px-16 lg:px-24 xl:px-32 py-12">
    ...
    <p className="text-sm text-slate-500 text-center mt-2 max-w-lg mx-auto">
      A visual collection of our most recent works — each piece crafted with intention, emotion, and
      style.
    </p>
    ...
    <div className="md:hidden mt-8">
      ...
      >
        {GALLERY_IMAGES.map((img, i) => (
          <div
            key={i}
            className="snap-center flex-shrink-0 w-[75vw] h-64 rounded-2xl overflow-hidden"
          >
            <img
...
export default function TemplateConCarrito() {
