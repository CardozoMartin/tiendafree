...
import GuiasTallesSection from './secciones/GuiasTallesSection';
...
type SeccionId = 'hero' | 'navbar' | 'categorias' | 'banner' | 'popup' | 'productos' | 'guiasTalles' | 'footer' | 'ajustes';
...
const TARJETAS: Tarjeta[] = [
  ...
  { id: 'guiasTalles', label: 'Guías de talles', desc: 'Tablas de medidas reusables para tus productos.',   icon: <IconGuiaTalles />, migrada: true },
...
export default function EditorSitio({ tienda }: Props) {
  ...
  if (seccion === 'guiasTalles') {
    return <GuiasTallesSection onVolver={() => setSeccion(null)} />;
  }
