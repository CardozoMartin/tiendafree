...
export const BANNER_CONFIGS: Record<string, BannerConfig> = {
  ...
  banner1: {
    ...
    layout: {
      ...
      productName: { x: 55, y: 30, fontSize: 32, maxWidth: '600px', color: '#ffffff', textAlign: 'left' },
      productDesc: { x: 55, y: 40, fontSize: 14, maxWidth: '500px', color: 'rgba(255,255,255,0.8)', textAlign: 'left' },
  ...
  cyber: {
    ...
    layout: {
      storeName: { x: 50, y: 8, fontSize: 14, color: '#ffffff', textAlign: 'center', shadow: '0 0 10px rgba(0,0,0,0.5)' },
      productImages: [
        { x: 50, y: 55, width: 30 },
      ],
      productName: { x: 50, y: 22, fontSize: 38, maxWidth: '800px', color: '#00f2ff', textAlign: 'center', shadow: '0 0 15px rgba(0,242,255,0.3)' },
      productDesc: { x: 50, y: 35, fontSize: 16, maxWidth: '600px', color: '#ffffff', textAlign: 'center' },
  ...
  degrade: {
    ...
    layout: {
      ...
      productName: { x: 10, y: 25, fontSize: 26, maxWidth: '500px', color: '#ffffff', textAlign: 'left' },
      productDesc: { x: 10, y: 40, fontSize: 14, maxWidth: '400px', color: 'rgba(255,255,255,0.9)', textAlign: 'left' },
  ...
  multi_focus: {
    ...
    layout: {
      ...
      productName: { x: 50, y: 18, fontSize: 24, maxWidth: '700px', color: '#333', textAlign: 'center' },
      productDesc: { x: 50, y: 88, fontSize: 12, maxWidth: '600px', color: '#666', textAlign: 'center' },
  ...
  card_clean: {
    ...
    layout: {
      ...
      productName: { x: 50, y: 75, fontSize: 48, maxWidth: '900px', color: '#111', textAlign: 'center' },
      productDesc: { x: 50, y: 82, fontSize: 20, maxWidth: '800px', color: '#666', textAlign: 'center' },
  ...
  card_dark: {
    ...
    layout: {
      ...
      productName: { x: 10, y: 74, fontSize: 44, maxWidth: '900px', color: '#fff', textAlign: 'left' },
      productDesc: { x: 10, y: 82, fontSize: 18, maxWidth: '850px', color: '#888', textAlign: 'left' },
  ...
  card_vibrant: {
    ...
    layout: {
      ...
      productName: { x: 50, y: 75, fontSize: 46, maxWidth: '900px', color: '#fff', textAlign: 'center' },
      productDesc: { x: 50, y: 82, fontSize: 22, maxWidth: '800px', color: 'rgba(255,255,255,0.8)', textAlign: 'center' },
