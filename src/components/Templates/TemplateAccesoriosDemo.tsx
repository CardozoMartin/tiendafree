...
// ── HERO PARALLAX ─────────────────────────────────────────────
function Hero({ titulo, descripcion, imgagenes }: IHeroProps) {
...
export default function TemplateAccesoriosDemo({ tienda, accent, themeConfig }: PlantillaAccesoriosProps) {
